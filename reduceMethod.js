...
// console.log(sumOfAges); would return the sum of all ages = 64
...
const usersObj = usersTwo.reduce((obj, user) => {
  obj[user.name] = user.age;
  return obj;
}, {});
// console.log(usersObj);  The console would display the value { John: 34, Amy: 20, camperCat: 10 }
...
function getRating(watchList) {
  ...
  let averageRating =
    filterData.reduce((sum, movie) => sum + movie) /
...
{
  /**
    Now that you have worked through a few challenges using higher-order functions like map(), 
    filter(), and reduce(), you now get to apply them to solve a more complex challenge.
